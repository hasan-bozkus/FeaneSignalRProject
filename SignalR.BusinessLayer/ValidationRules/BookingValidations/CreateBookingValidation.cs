...
namespace SignalR.BusinessLayer.ValidationRules.BookingValidations
{
    public class CreateBookingValidation : AbstractValidator<CreateBookingDto>
    {
        public CreateBookingValidation()
        {
            ...
            RuleFor(x => x.Name).MinimumLength(5).WithMessage("Lütfen isim alanına en az 5 karakter veri girişi yapını").MaximumLength(50).WithMessage("Lütfen isim alanına en fazla 50 karakter veri girişi yapınız");
            RuleFor(x => x.Name).MaximumLength(50).WithMessage("Lütfen açıklama alanına en fazla 500 karakter veri girişi yapınız");
